...
This has been based on the gae-python and php server implementations already developed and borrows heavily on their implemenations.

To test unpack in the server directory of jQuery-File-Upload.
